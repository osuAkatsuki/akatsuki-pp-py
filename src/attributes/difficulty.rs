...
use akatsuki_pp::{
    ...
    osu_2019::stars::OsuDifficultyAttributes as Osu2019DifficultyAttributes
};
...
impl From<Osu2019DifficultyAttributes> for PyDifficultyAttributes {
    fn from(attrs: Osu2019DifficultyAttributes) -> Self {
        let Osu2019DifficultyAttributes {
            aim_strain,
            speed_strain,
            od,
            cs,
        ...
        Self {
            ...
            is_convert: false,
            aim: Some(aim_strain),
            speed: Some(speed_strain),
            od: Some(od),
            cs: Some(cs),
            beatmap_id: Some(beatmap_id),
            beatmap_creator: Some(beatmap_creator),
            ar: Some(ar),
            hp: Some(hp),
            n_circles: Some(n_circles.try_into().unwrap()),
            n_sliders: Some(n_sliders.try_into().unwrap()),
            n_spinners: Some(n_spinners.try_into().unwrap()),
            aim_difficult_strain_count: Some(aim_difficult_strain_count),
            speed_difficult_strain_count: Some(speed_difficult_strain_count),
            max_combo: max_combo.try_into().unwrap(),
            ..Self::default()
        }
    }
}
