...
use akatsuki_pp::{
    ...
    taiko::TaikoPerformanceAttributes, osu_2019::stars::OsuPerformanceAttributes as Osu2019PerformanceAttributes,
};
...
impl From<Osu2019PerformanceAttributes> for PyPerformanceAttributes {
    fn from(attrs: Osu2019PerformanceAttributes) -> Self {
        let Osu2019PerformanceAttributes {
            difficulty,
            pp,
            pp_acc,
            pp_aim,
